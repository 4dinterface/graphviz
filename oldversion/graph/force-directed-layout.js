...
Layout.ForceDirected = function(graph, options) {
  ...
  this.init = function() {
    ...
    //console.log("!",temperature,nodes_length,edges_length,forceConstant,attraction_constant,repulsion_constant);
  };
  ...
  this.generate = function() {
    if(layout_iterations < this.max_iterations && temperature > 0.000001) {
      ...
      for(var i=0; i < nodes_length; i++) {
        ...
        //console.log("node_v.layout.offset_x",node_v.layout.offset_x);
        ...
        //console.log("2",node_v.layout.tmp_pos_x );
